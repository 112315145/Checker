...
.. topic:: **So Which Bot is Better?**
    ...
    When playing against human opponents, our RL bot, falls short due to the extensive training it requires. In contrast, Minimax bot with a search depth of 3 proves to be a significantly more formidable opponent.
